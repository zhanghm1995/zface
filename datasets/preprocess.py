...
Date: 2022-09-17 16:50:07
Email: haimingzhang@link.cuhk.edu.cn
Description: This script contains the image preprocessing code for Deep3DFaceRecon_pytorch
'''
...
class FaceAligner(object):
    ...
    def align_face(self, input_image, landmarks, mask=None):
        trans_params, img_new, lm_new, mask_new = \
            align_img(input_image, landmarks, self.lm3d_std, mask)
